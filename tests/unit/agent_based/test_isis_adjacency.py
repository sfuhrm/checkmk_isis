...
@pytest.mark.parametrize('string_table, result', [
    (
        ...
        {
            '10.0.0.1': {'Neighbor IP': '10.0.0.1', 'State': 3},
            '192.168.0.1': {'Neighbor IP': '192.168.0.1', 'State': 3},
            'fe80::8c21:b316:7d4e:a9dd': {'Neighbor IP': 'fe80::8c21:b316:7d4e:a9dd', 'State': 3}
        }
    ),
])
...
@pytest.mark.parametrize('item, section, result', [
    ...
    (
        ...
        {
            '10.0.0.1': {'Neighbor IP': '10.0.0.1', 'State': 3},
            '192.168.0.1': {'Neighbor IP': '192.168.0.1', 'State': 1},
            'fe80::8c21:b316:7d4e:a9dd': {'Neighbor IP': 'fe80::8c21:b316:7d4e:a9dd', 'State': 3}
        },
    ...
    (
        '10.0.0.1',
        {
            '10.0.0.1': {'Neighbor IP': '10.0.0.1', 'State': 1},
            '192.168.0.1': {'Neighbor IP': '192.168.0.1', 'State': 3},
            'fe80::8c21:b316:7d4e:a9dd': {'Neighbor IP': 'fe80::8c21:b316:7d4e:a9dd', 'State': 3}
        },
